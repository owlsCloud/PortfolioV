...
const HireMe = () => {
  return (
    <div className="fixed left-0 bottom-4 flex  items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto md:absolute">
      <div className="w-50 h-auto flex items-center justify-center relative md:w-25">
        <CircularText
